...
class ProcessTransactionRequest {
  ...
  factory ProcessTransactionRequest.fromRawJson(String str) =>
      ProcessTransactionRequest.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ProcessTransactionRequest.fromJson(Map<String, dynamic> json) =>
      ProcessTransactionRequest(
