...
class ReverseTransactionResponse {
  ...
  factory ReverseTransactionResponse.fromRawJson(String str) =>
      ReverseTransactionResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ReverseTransactionResponse.fromJson(Map<String, dynamic> json) =>
      ReverseTransactionResponse(
